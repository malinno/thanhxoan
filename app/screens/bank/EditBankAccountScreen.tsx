...
const EditBankAccountScreen: FC<Props> = ({ route, ...props }) => {
  ...
  useEffect(() => {
    setData({
      bank: [
        route.params.bankAccount.bank_id.id,
        route.params.bankAccount.bank_id.name,
      ],
      bank_branch: route.params.bankAccount.bank_branch,
      account_owner: route.params.bankAccount.account_owner,
      account_number: route.params.bankAccount.account_number,
    });
    return () => {
      resetForm();
    };
