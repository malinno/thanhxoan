...
type PosOrdersFilterState = {
  from?: dayjs.Dayjs;
  to?: dayjs.Dayjs;
};

const PosOrdersFilterScreen: FC<Props> = ({ route, ...props }) => {
  const navigation = useNavigation();
  const user = useAuth(state => state.user);

  const [filter, setFilter] = useState<PosOrdersFilterState>({});
...
export default PosOrdersFilterScreen;
