...
import { PROMOTION_STATUS_MAPPING } from '@app/constants/promotion-statuses.constant';
...
interface Props extends ViewProps {
  ...
  onPress?: (data: PromotionProgram) => void;
}

const PromotionItem: FC<Props> = memo(props => {
  ...
  const status = PROMOTION_STATUS_MAPPING[data.trang_thai];
