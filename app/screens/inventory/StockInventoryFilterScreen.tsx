...
type StockInventoryFilterViewModel = {
  state?: [StockInventoryState, string];
  from?: dayjs.Dayjs;
  to?: dayjs.Dayjs;
};

const StockInventoryFilterScreen: FC<Props> = ({ route, ...props }) => {
  const navigation = useNavigation();
  const [filter, setFilter] = useState<StockInventoryFilterViewModel>({});
...
export default StockInventoryFilterScreen;
